<template>
    ...
    >
        <div class="ipopup_con">
            ...
            <div class="text_con flex_c flex_ac">
                <div class="p">
                    {{
                        text == 1
                            ? "复制链接浏览器下载"
                ...
                <div class="p">
                    ...
                    ><span class="corr">完整版芒星赏APP</span>
                </div>
                ...
                <div
                    ...
                    @click="
                        copy(
                            'https://img.chaoshewang.com/apk/release_v0.0.1.apk'
                        )
                    "
                >
                    点击复制下载链接
                </div>
                <!-- <div class="btn" @click="copy('http://www.chaoshewang.com')">点击复制下载链接</div> -->
            </div>
        </div>
    </u-popup>
</template>
