        ...
        <view class="ocean" :style="{ backgroundImage: `url(${imageUrlMap.bg})` }">
            <view class="particulars">
                ...
                <view class="attention" :style="{
                    ...
                    <view class="text">
                        1.公司有权根据实际情况对活动规则进行必要的调整或解释，以确保活动的公平、公正和顺利进行。<br />2.用户参与活动时需遵守芒盒APP的相关规定和法律法规要求，不得采用任何不正当手段参与活动或获取奖励。例大小号互绑/家人号互绑/机刷用户互绑、佣金邀新等违规方法邀新，将无法获得奖励。对于违规行为，芒盒文化传播公司有权取消用户的参与资格及已获得的奖励。
                    </view>
                </view>
            </view>
        </view>
