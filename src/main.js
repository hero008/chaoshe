...
import {timesAmount,subAmount,addAmount,isMTVapp,closeMGTVWebview} from '@/utils/mgtv.js';
...
Vue.prototype.MTVapp = isMTVapp; // 复制
Vue.prototype.closeMGTVWebview = closeMGTVWebview; // 复制
